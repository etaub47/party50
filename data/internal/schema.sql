...
\restrict BbAsOCCAao5yEWxWCBjXmBWweNquAlBOgUfjJQ0mlrMpfIunTP9lRsSvhJpPgJQ
...
--
-- Name: purchase_item_with_discount(uuid, uuid, text); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public.purchase_item_with_discount(p_player_id uuid, p_item_id uuid, p_player_role text) RETURNS void
    LANGUAGE plpgsql SECURITY DEFINER
    AS $$
DECLARE
v_item_cost INTEGER;
...
ALTER FUNCTION public.purchase_item_with_discount(p_player_id uuid, p_item_id uuid, p_player_role text) OWNER TO postgres;
...
CREATE TABLE public.player (
    ...
    max_intel integer DEFAULT 250 NOT NULL,
    legal_advice boolean DEFAULT false NOT NULL
);
...
--
-- Name: player_challenge; Type: TABLE; Schema: public; Owner: postgres
--
...
ALTER TABLE ONLY public.player_challenge REPLICA IDENTITY FULL;


ALTER TABLE public.player_challenge OWNER TO postgres;

--
-- Name: player_event; Type: TABLE; Schema: public; Owner: postgres
--
...
ALTER TABLE public.player_event OWNER TO postgres;
...
ALTER TABLE ONLY public.player_item REPLICA IDENTITY FULL;


ALTER TABLE public.player_item OWNER TO postgres;

--
-- Name: player_stats; Type: VIEW; Schema: public; Owner: postgres
--
...
CREATE VIEW public.player_stats WITH (security_invoker='true') AS
 SELECT id,
    ...
    (COALESCE(( SELECT sum(i.intel) AS sum
           FROM (public.player_item pi
             JOIN public.item i ON ((pi.item_id = i.id)))
          WHERE (pi.player_id = p.id)), (0)::bigint) + COALESCE(( SELECT sum(e.intel) AS sum
           FROM (public.player_event pe
             JOIN public.event e ON ((pe.event_id = e.id)))
          WHERE (pe.player_id = p.id)), (0)::bigint)) AS total_intel,
    GREATEST((0)::bigint, (COALESCE(( SELECT sum(i.heat) AS sum
           FROM (public.player_item pi
             JOIN public.item i ON ((pi.item_id = i.id)))
          WHERE (pi.player_id = p.id)), (0)::bigint) + COALESCE(( SELECT sum(e.heat) AS sum
           FROM (public.player_event pe
             JOIN public.event e ON ((pe.event_id = e.id)))
          WHERE (pe.player_id = p.id)), (0)::bigint))) AS total_heat,
    (250 +
        CASE
            WHEN (EXISTS ( SELECT 1
               FROM (public.player_item pi
                 JOIN public.item i ON ((pi.item_id = i.id)))
              WHERE ((pi.player_id = p.id) AND (i.name = '8TB Thumb Drive'::text)))) THEN 250
            ELSE 0
        END) AS max_intel,
    (100 +
        CASE
            WHEN (EXISTS ( SELECT 1
               FROM (public.player_item pi
                 JOIN public.item i ON ((pi.item_id = i.id)))
              WHERE ((pi.player_id = p.id) AND (i.name = 'Offshore Account'::text)))) THEN 400
            ELSE 0
        END) AS max_credits,
        CASE
            WHEN ((COALESCE(( SELECT sum(i.heat) AS sum
               FROM (public.player_item pi
                 JOIN public.item i ON ((pi.item_id = i.id)))
              WHERE (pi.player_id = p.id)), (0)::bigint) + COALESCE(( SELECT sum(e.heat) AS sum
               FROM (public.player_event pe
                 JOIN public.event e ON ((pe.event_id = e.id)))
              WHERE (pe.player_id = p.id)), (0)::bigint)) >= 100) THEN true
            ELSE false
...
--
-- Name: event event_step_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.event
    ADD CONSTRAINT event_step_pkey PRIMARY KEY (id);
...
--
-- Name: player_challenge player_challenge_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.player_challenge
    ADD CONSTRAINT player_challenge_pkey PRIMARY KEY (id);


--
-- Name: player_challenge player_challenge_player_id_challenge_id_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.player_challenge
    ADD CONSTRAINT player_challenge_player_id_challenge_id_key UNIQUE (player_id, challenge_id);


--
-- Name: player_event player_event_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.player_event
    ADD CONSTRAINT player_event_pkey PRIMARY KEY (player_id, event_id);
...
ALTER TABLE ONLY public.player_item
    ADD CONSTRAINT player_item_pkey PRIMARY KEY (player_id, item_id);
...
--
-- Name: player_challenge player_challenge_player_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.player_challenge
    ADD CONSTRAINT player_challenge_player_id_fkey FOREIGN KEY (player_id) REFERENCES public.player(id) ON DELETE CASCADE;


--
-- Name: player_event player_event_event_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.player_event
    ADD CONSTRAINT player_event_event_id_fkey FOREIGN KEY (event_id) REFERENCES public.event(id) ON UPDATE CASCADE;


--
-- Name: player_event player_event_player_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.player_event
    ADD CONSTRAINT player_event_player_id_fkey FOREIGN KEY (player_id) REFERENCES public.player(id) ON UPDATE CASCADE ON DELETE CASCADE;


--
-- Name: player player_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.player
    ADD CONSTRAINT player_id_fkey FOREIGN KEY (id) REFERENCES auth.users(id) ON UPDATE CASCADE ON DELETE CASCADE;


--
-- Name: player_item player_item_item_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.player_item
    ADD CONSTRAINT player_item_item_id_fkey FOREIGN KEY (item_id) REFERENCES public.item(id) ON UPDATE CASCADE ON DELETE CASCADE;


--
-- Name: player_item player_item_player_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.player_item
    ADD CONSTRAINT player_item_player_id_fkey FOREIGN KEY (player_id) REFERENCES public.player(id) ON UPDATE CASCADE ON DELETE CASCADE;
...
--
-- Name: player Allow anonymous insert; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "Allow anonymous insert" ON public.player FOR INSERT WITH CHECK (true);


--
-- Name: event Everyone can query events; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "Everyone can query events" ON public.event FOR SELECT TO authenticated USING (true);


--
-- Name: item Everyone can query items; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "Everyone can query items" ON public.item FOR SELECT TO authenticated USING (true);


--
-- Name: player_event Players can manage their own events; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "Players can manage their own events" ON public.player_event TO authenticated USING ((auth.uid() = player_id));


--
-- Name: player_item Players can manage their own items; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "Players can manage their own items" ON public.player_item TO authenticated USING ((player_id = auth.uid()));


--
-- Name: player Players can manage their own profile; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "Players can manage their own profile" ON public.player TO authenticated USING ((auth.uid() = id));


--
-- Name: player Players can see scores; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "Players can see scores" ON public.player FOR SELECT TO authenticated USING (true);


--
-- Name: player_event Players can view all player events; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "Players can view all player events" ON public.player_event FOR SELECT TO authenticated, anon USING (true);


--
-- Name: player_item Players can view all player items; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "Players can view all player items" ON public.player_item FOR SELECT TO authenticated, anon USING (true);


--
-- Name: player_challenge Users can insert own challenge; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "Users can insert own challenge" ON public.player_challenge FOR INSERT TO authenticated, anon WITH CHECK ((auth.uid() = player_id));
...
--
-- Name: player_challenge; Type: ROW SECURITY; Schema: public; Owner: postgres
--

ALTER TABLE public.player_challenge ENABLE ROW LEVEL SECURITY;

--
-- Name: player_challenge player_challenge_lobby_view; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY player_challenge_lobby_view ON public.player_challenge FOR SELECT TO authenticated, anon USING ((status = 'WAITING'::text));


--
-- Name: player_challenge player_challenge_select_own; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY player_challenge_select_own ON public.player_challenge FOR SELECT TO authenticated, anon USING ((auth.uid() = player_id));


--
-- Name: player_challenge player_challenge_select_team; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY player_challenge_select_team ON public.player_challenge FOR SELECT TO authenticated, anon USING ((team_id IN ( SELECT public.get_my_team_ids() AS get_my_team_ids)));


--
-- Name: player_challenge player_challenge_update_own; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY player_challenge_update_own ON public.player_challenge FOR UPDATE TO authenticated, anon USING ((auth.uid() = player_id));


--
-- Name: player_event; Type: ROW SECURITY; Schema: public; Owner: postgres
--

ALTER TABLE public.player_event ENABLE ROW LEVEL SECURITY;

--
-- Name: player_item; Type: ROW SECURITY; Schema: public; Owner: postgres
--

ALTER TABLE public.player_item ENABLE ROW LEVEL SECURITY;
...
--
-- Name: supabase_realtime player; Type: PUBLICATION TABLE; Schema: public; Owner: postgres
--
...
--
-- Name: supabase_realtime player_challenge; Type: PUBLICATION TABLE; Schema: public; Owner: postgres
--

ALTER PUBLICATION supabase_realtime ADD TABLE ONLY public.player_challenge;


--
-- Name: supabase_realtime player_event; Type: PUBLICATION TABLE; Schema: public; Owner: postgres
--

ALTER PUBLICATION supabase_realtime ADD TABLE ONLY public.player_event;


--
-- Name: supabase_realtime player_item; Type: PUBLICATION TABLE; Schema: public; Owner: postgres
--

ALTER PUBLICATION supabase_realtime ADD TABLE ONLY public.player_item;
...
--
-- Name: FUNCTION purchase_item_with_discount(p_player_id uuid, p_item_id uuid, p_player_role text); Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON FUNCTION public.purchase_item_with_discount(p_player_id uuid, p_item_id uuid, p_player_role text) TO anon;
GRANT ALL ON FUNCTION public.purchase_item_with_discount(p_player_id uuid, p_item_id uuid, p_player_role text) TO authenticated;
GRANT ALL ON FUNCTION public.purchase_item_with_discount(p_player_id uuid, p_item_id uuid, p_player_role text) TO service_role;
...
--
-- Name: TABLE player_challenge; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON TABLE public.player_challenge TO anon;
GRANT ALL ON TABLE public.player_challenge TO authenticated;
GRANT ALL ON TABLE public.player_challenge TO service_role;


--
-- Name: TABLE player_event; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON TABLE public.player_event TO anon;
GRANT ALL ON TABLE public.player_event TO authenticated;
GRANT ALL ON TABLE public.player_event TO service_role;


--
-- Name: TABLE player_item; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON TABLE public.player_item TO anon;
GRANT ALL ON TABLE public.player_item TO authenticated;
GRANT ALL ON TABLE public.player_item TO service_role;
...
\unrestrict BbAsOCCAao5yEWxWCBjXmBWweNquAlBOgUfjJQ0mlrMpfIunTP9lRsSvhJpPgJQ
